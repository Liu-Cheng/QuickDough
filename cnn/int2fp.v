...
module  int2fp_altbarrel_shift_fof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //int2fp_altbarrel_shift_fof
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int2fp_altfp_convert_7qm
	( 
	clock,
	dataa,
	result) ;
	...
	int2fp_altbarrel_shift_fof   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //int2fp_altfp_convert_7qm
//VALID FILE
...
module int2fp (
	...
	int2fp_altfp_convert_7qm	int2fp_altfp_convert_7qm_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
