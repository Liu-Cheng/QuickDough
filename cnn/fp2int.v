...
module  fp2int_altbarrel_shift_kof
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp2int_altbarrel_shift_kof

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp2int_altfp_convert_7qm
	( 
	clock,
	dataa,
	result) ;
	...
	fp2int_altbarrel_shift_kof   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp2int_altfp_convert_7qm
//VALID FILE
...
module fp2int (
	...
	fp2int_altfp_convert_7qm	fp2int_altfp_convert_7qm_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
