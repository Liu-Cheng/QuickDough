...
#include "usr_acc.h"
#define SUCCESS 0
#define DEVICE_NAME "/dev/usr_acc"

#define USR_ACC_REG 0x43C00000
static void *mmio;
...
static void set_usr_acc_ctrl(void){
    printk("KERNEL PRINT : set usr_acc module \n\r");
...
int device_ioctl( struct file *file, /* ditto */
    ...
    int *temp;
    switch (ioctl_num){
        case IOCTL_ACC_START:
            temp = (int *)ioctl_param;
            set_usr_acc_ctrl(temp);
            break;
        case IOCTL_STOP_LED:
...
static int __init usr_acc_init(void){
    int rc = 0;
...
static void __exit usr_acc_exit(void){
    unregister_chrdev(major_num, DEVICE_NAME);
    platform_driver_unregister(&usr_acc_driver);
    printk(KERN_ALERT "Goodbye module world.\n");
}

module_init(usr_acc_init);
module_exit(usr_acc_exit);
