...
HD_PWD='/home/liucheng/research/zynq-dev/dma_demo_zed_hw/dma_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log base_sys_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source base_sys_wrapper.tcl -notrace
