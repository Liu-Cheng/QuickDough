...
HD_PWD='/home/liucheng/research/zynq-dev/dma_demo_zed_hw/dma_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log base_sys_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source base_sys_wrapper.tcl
