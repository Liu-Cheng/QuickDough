...
################################################################
# This is a generated script based on design: base_sys
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: acc_ip_0, and set properties
  set acc_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:acc_ip:1.0 acc_ip_0 ]
...
CONFIG.NUM_SI {1} \
  ...
  # Create instance: usr_dma_0, and set properties
  set usr_dma_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:usr_dma:1.0 usr_dma_0 ]
...
CONFIG.CONST_WIDTH {32} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI] [get_bd_intf_pins usr_dma_0/S_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M01_AXI [get_bd_intf_pins acc_ip_0/S00_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net usr_dma_0_M0_AXI [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins usr_dma_0/M0_AXI]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_intf_nets usr_dma_0_M0_AXI]

  # Create port connections
  connect_bd_net -net acc_ip_0_acc_intr [get_bd_pins acc_ip_0/acc_intr] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins acc_ip_0/s00_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk] [get_bd_pins usr_dma_0/M0_AXI_ACLK] [get_bd_pins usr_dma_0/S_AXI_ACLK]
  ...
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins acc_ip_0/s00_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn] [get_bd_pins usr_dma_0/M0_AXI_ARESETN] [get_bd_pins usr_dma_0/S_AXI_ARESETN]
  connect_bd_net -net usr_dma_0_interrupt [get_bd_pins usr_dma_0/interrupt] [get_bd_pins xlconcat_0/In0]
  set_property -dict [ list \
HDL_ATTRIBUTE.MARK_DEBUG {true} \
 ] [get_bd_nets usr_dma_0_interrupt]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins usr_dma_0/face_sel] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins usr_dma_0/face_ena] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_2_dout [get_bd_pins usr_dma_0/face_addr] [get_bd_pins xlconstant_2/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs acc_ip_0/S00_AXI/S00_AXI_reg] SEG_acc_ip_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs usr_dma_0/S_AXI/reg0] SEG_usr_dma_0_reg0
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces usr_dma_0/M0_AXI] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
...
preplace inst xlconstant_0 -pg 1 -lvl 2 -y 340 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 1 -y 130 -defaultsOSRD
preplace inst xlconstant_1 -pg 1 -lvl 2 -y 420 -defaultsOSRD
preplace inst xlconstant_2 -pg 1 -lvl 2 -y 500 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -y 320 -defaultsOSRD
preplace inst acc_ip_0 -pg 1 -lvl 3 -y 200 -defaultsOSRD
preplace inst usr_dma_0 -pg 1 -lvl 3 -y 370 -defaultsOSRD
...
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 370 20 NJ 20 NJ 260 NJ 270 1680
preplace netloc usr_dma_0_M0_AXI 1 3 1 930
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 10 NJ 10 NJ 10 NJ 10 NJ 10 1690
preplace netloc acc_ip_0_acc_intr 1 3 1 920
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 3 370 560 690 130 940
...
preplace netloc usr_dma_0_interrupt 1 3 1 960
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 3 350 30 NJ 30 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 30 40 360 550 670 110 960 250 1260 280 1670
preplace netloc processing_system7_0_axi_periph_M01_AXI 1 2 1 N
levelinfo -pg 1 0 190 510 810 1110 1470 1710 -top 0 -bot 570
",
}
