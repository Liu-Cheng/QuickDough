...
for.inc.146:                                      ; preds = %for.body7.137
  ...
  br label %for.inc.1.155

for.inc.1.155:                                    ; preds = %for.inc.146
  ...
  br label %for.inc.2.164

for.inc.2.164:                                    ; preds = %for.inc.1.155
  ...
  br label %for.inc.3.165

for.inc.3.165:                                    ; preds = %for.inc.2.164
  br label %for.inc14.166

for.inc14.166:                                    ; preds = %for.inc.3.165
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 1, i32 1), align 4
  br label %for.body7.1.1

for.body7.1.1:                                    ; preds = %for.inc14.166
...
for.inc14.1.1:                                    ; preds = %for.inc.3.1.1
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 1, i32 2), align 4
  br label %for.body7.2.1

for.body7.2.1:                                    ; preds = %for.inc14.1.1
  ...
  br label %for.inc.218.1

for.inc.218.1:                                    ; preds = %for.body7.2.1
...
for.inc.1.2.1:                                    ; preds = %for.inc.218.1
...
for.inc14.2.1:                                    ; preds = %for.inc.3.2.1
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 1, i32 3), align 4
  br label %for.body7.3.1

for.body7.3.1:                                    ; preds = %for.inc14.2.1
  ...
  br label %for.inc.326.1

for.inc.326.1:                                    ; preds = %for.body7.3.1
...
for.inc.1.3.1:                                    ; preds = %for.inc.326.1
...
for.inc14.3.1:                                    ; preds = %for.inc.3.3.1
  br label %for.inc17.1

for.inc17.1:                                      ; preds = %for.inc14.3.1
  br label %for.body3.2

for.body3.2:                                      ; preds = %for.inc17.1
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 2, i32 0), align 4
  br label %for.body7.276

for.body7.276:                                    ; preds = %for.body3.2
...
for.inc.285:                                      ; preds = %for.body7.276
  ...
  br label %for.inc.1.294

for.inc.1.294:                                    ; preds = %for.inc.285
  ...
  br label %for.inc.2.2103

for.inc.2.2103:                                   ; preds = %for.inc.1.294
  ...
  br label %for.inc.3.2104

for.inc.3.2104:                                   ; preds = %for.inc.2.2103
  br label %for.inc14.2105

for.inc14.2105:                                   ; preds = %for.inc.3.2104
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 2, i32 1), align 4
  br label %for.body7.1.2

for.body7.1.2:                                    ; preds = %for.inc14.2105
  ...
  br label %for.inc.110.2

for.inc.110.2:                                    ; preds = %for.body7.1.2
...
for.inc.1.1.2:                                    ; preds = %for.inc.110.2
...
for.inc14.1.2:                                    ; preds = %for.inc.3.1.2
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 2, i32 2), align 4
  br label %for.body7.2.2

for.body7.2.2:                                    ; preds = %for.inc14.1.2
  ...
  br label %for.inc.218.2

for.inc.218.2:                                    ; preds = %for.body7.2.2
...
for.inc.1.2.2:                                    ; preds = %for.inc.218.2
...
for.inc14.2.2:                                    ; preds = %for.inc.3.2.2
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 2, i32 3), align 4
  br label %for.body7.3.2

for.body7.3.2:                                    ; preds = %for.inc14.2.2
  ...
  br label %for.inc.326.2

for.inc.326.2:                                    ; preds = %for.body7.3.2
...
for.inc.1.3.2:                                    ; preds = %for.inc.326.2
...
for.inc14.3.2:                                    ; preds = %for.inc.3.3.2
  br label %for.inc17.2

for.inc17.2:                                      ; preds = %for.inc14.3.2
  br label %for.body3.3

for.body3.3:                                      ; preds = %for.inc17.2
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 3, i32 0), align 4
  br label %for.body7.3115

for.body7.3115:                                   ; preds = %for.body3.3
  ...
  br label %for.inc.3124

for.inc.3124:                                     ; preds = %for.body7.3115
  ...
  br label %for.inc.1.3133

for.inc.1.3133:                                   ; preds = %for.inc.3124
  ...
  br label %for.inc.2.3142

for.inc.2.3142:                                   ; preds = %for.inc.1.3133
  ...
  br label %for.inc.3.3143

for.inc.3.3143:                                   ; preds = %for.inc.2.3142
  br label %for.inc14.3144

for.inc14.3144:                                   ; preds = %for.inc.3.3143
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 3, i32 1), align 4
  br label %for.body7.1.3

for.body7.1.3:                                    ; preds = %for.inc14.3144
  ...
  br label %for.inc.110.3

for.inc.110.3:                                    ; preds = %for.body7.1.3
...
for.inc.1.1.3:                                    ; preds = %for.inc.110.3
...
for.inc14.1.3:                                    ; preds = %for.inc.3.1.3
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 3, i32 2), align 4
  br label %for.body7.2.3

for.body7.2.3:                                    ; preds = %for.inc14.1.3
  ...
  br label %for.inc.218.3

for.inc.218.3:                                    ; preds = %for.body7.2.3
...
for.inc.1.2.3:                                    ; preds = %for.inc.218.3
...
for.inc14.2.3:                                    ; preds = %for.inc.3.2.3
  store i32 0, i32* getelementptr inbounds ([4 x [4 x i32]]* @c, i32 0, i32 3, i32 3), align 4
  br label %for.body7.3.3

for.body7.3.3:                                    ; preds = %for.inc14.2.3
  ...
  br label %for.inc.326.3

for.inc.326.3:                                    ; preds = %for.body7.3.3
...
for.inc.1.3.3:                                    ; preds = %for.inc.326.3
...
for.inc14.3.3:                                    ; preds = %for.inc.3.3.3
  br label %for.inc17.3

for.inc17.3:                                      ; preds = %for.inc14.3.3
  ret void
}
