...
for.body3:                                        ; preds = %for.cond1
  ...
  %5 = load [9 x i32]** %c.addr, align 8
  %arrayidx = getelementptr inbounds [9 x i32]* %5, i64 %idxprom4
  %arrayidx5 = getelementptr inbounds [9 x i32]* %arrayidx, i32 0, i64 %idxprom
...
for.body8:                                        ; preds = %for.cond6
  ...
  %9 = load [9 x i32]** %a.addr, align 8
  %arrayidx11 = getelementptr inbounds [9 x i32]* %9, i64 %idxprom10
  %arrayidx12 = getelementptr inbounds [9 x i32]* %arrayidx11, i32 0, i64 %idxprom9
  %10 = load i32* %arrayidx12, align 4
  %11 = load i32* %j, align 4
  %idxprom13 = sext i32 %11 to i64
  %12 = load i32* %k, align 4
  %idxprom14 = sext i32 %12 to i64
  %13 = load [9 x i32]** %b.addr, align 8
  %arrayidx15 = getelementptr inbounds [9 x i32]* %13, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [9 x i32]* %arrayidx15, i32 0, i64 %idxprom13
  ...
  %17 = load [9 x i32]** %c.addr, align 8
  %arrayidx19 = getelementptr inbounds [9 x i32]* %17, i64 %idxprom18
  %arrayidx20 = getelementptr inbounds [9 x i32]* %arrayidx19, i32 0, i64 %idxprom17
