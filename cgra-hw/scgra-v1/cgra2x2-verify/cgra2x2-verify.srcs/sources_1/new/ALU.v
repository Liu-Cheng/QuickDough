...
reg [DWIDTH-1:0]             MULADDSUB_Result;
...
always@(posedge Clk or negedge Resetn) begin
  if(!Resetn) begin
    ...
    Mul_Result <=  ALU_In0_Reg0 * ALU_In1_Reg0;
  end
end
...
always@(posedge Clk or negedge Resetn) begin
    ...
    else if(Is_MULADD_Reg) begin
        MULADDSUB_Result <= Mul_Result + ALU_In2_Reg1;
    end
    else begin
        MULADDSUB_Result <= Mul_Result - ALU_In2_Reg1;
    end
