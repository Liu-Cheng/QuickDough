...
int FPGA_Acc(void){
	...
	XDma_PS_Move((u32)(Sig_In), Input_Buffer_Addr, L, 0);
	Input_Buffer_Addr += L*4;

	XDma_PS_Move((u32)(Coeff), Input_Buffer_Addr, N, 0);
	Input_Buffer_Addr += N*4;
	...
	Xil_DCacheFlushRange((u32)(FPGA_Sig_Out), L*4);
	XDma_PS_Move(Output_Buffer_Addr, (u32)(FPGA_Sig_Out), L, 0);
	Output_Buffer_Addr += L*4;
