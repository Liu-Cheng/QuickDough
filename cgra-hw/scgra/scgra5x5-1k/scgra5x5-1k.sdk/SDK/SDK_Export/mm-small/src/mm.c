...
int FPGA_Acc(void){
	...
	XDma_PS_Move((u32)(&A_In[0][0]), Bram0_Base_Addr+Const_Num*4, N*N, 0);

	XDma_PS_Move((u32)(&B_In[0][0]), Bram0_Base_Addr + (Const_Num+N*N)*4, N*N, 0);
	...
	XDma_PS_Move(Bram1_Base_Addr, (u32)(&FPGA_C_Out[0][0]), N*N, 0);
	//GPIO_Move(&FPGA_C_Out[0][0], Bram1_Base_Addr, N*N, 0);
