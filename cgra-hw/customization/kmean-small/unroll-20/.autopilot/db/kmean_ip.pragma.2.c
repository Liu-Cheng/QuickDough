# 1 "D:/minibench/customization/kmean-small/unroll-20/.autopilot/db/kmean_ip.pragma.1.c"
# 1 "D:/minibench/customization/kmean-small/unroll-20/.autopilot/db/kmean_ip.pragma.1.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "D:/minibench/customization/kmean-small/unroll-20/.autopilot/db/kmean_ip.pragma.1.c" 2
# 1 "kmean-small/src/kmean_ip.c"
# 1 "kmean-small/src/kmean_ip.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
...
# 9 "<command line>" 2
# 1 "<built-in>" 2
# 1 "kmean-small/src/kmean_ip.c" 2
# 1 "kmean-small/src/kmean.h" 1
...
void kmean_ip(int sub_in[1024*2 +4*2], int sub_out[4*2 +4]){_ssdm_SpecArrayDimSize(sub_in,1024*2 +4*2);_ssdm_SpecArrayDimSize(sub_out,4*2 +4);
_ssdm_op_SpecResource(sub_out, "", "RAM_1P_BRAM", "", "", "", "");
# 3 "kmean-small/src/kmean_ip.c"
...
# 3 "kmean-small/src/kmean_ip.c"
    ...
    kmean_ip_label0:for(i=0; i<1024; i++){_ssdm_op_SpecLoopName("kmean_ip_label0");_ssdm_RegionBegin("kmean_ip_label0");
_ssdm_op_SpecPipeline(1, 1, 1, "");
# 20 "kmean-small/src/kmean_ip.c"
...
# 20 "kmean-small/src/kmean_ip.c"
    ...
    _ssdm_RegionEnd("kmean_ip_label0");}
