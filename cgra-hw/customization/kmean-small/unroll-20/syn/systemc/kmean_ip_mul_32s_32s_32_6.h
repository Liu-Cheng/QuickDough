...
#ifndef __kmean_ip_mul_32s_32s_32_6__HH__
#define __kmean_ip_mul_32s_32s_32_6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(kmean_ip_mul_32s_32s_32_6) {
    ...
    SC_CTOR(kmean_ip_mul_32s_32s_32_6):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
