...
#ifndef __fir_ip_mul_32s_32s_32_6__HH__
#define __fir_ip_mul_32s_32s_32_6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_ip_mul_32s_32s_32_6) {
    ...
    SC_CTOR(fir_ip_mul_32s_32s_32_6):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
