...
wire [8 - 1:0] sig_fir_ip_sub_in_address0;
wire sig_fir_ip_sub_in_ce0;
wire [32 - 1:0] sig_fir_ip_sub_in_q0;


wire [6 - 1:0] sig_fir_ip_sub_out_address0;
wire sig_fir_ip_sub_out_ce0;
wire sig_fir_ip_sub_out_we0;
wire [32 - 1:0] sig_fir_ip_sub_out_d0;

wire sig_fir_ip_ap_start;
wire sig_fir_ip_ap_ready;
wire sig_fir_ip_ap_done;
wire sig_fir_ip_ap_idle;

wire sig_fir_ip_ap_rst;



fir_ip fir_ip_U(
    .sub_in_address0(sig_fir_ip_sub_in_address0),
    .sub_in_ce0(sig_fir_ip_sub_in_ce0),
    .sub_in_q0(sig_fir_ip_sub_in_q0),
    .sub_out_address0(sig_fir_ip_sub_out_address0),
    .sub_out_ce0(sig_fir_ip_sub_out_ce0),
    .sub_out_we0(sig_fir_ip_sub_out_we0),
    .sub_out_d0(sig_fir_ip_sub_out_d0),
    .ap_start(sig_fir_ip_ap_start),
    .ap_ready(sig_fir_ip_ap_ready),
    .ap_done(sig_fir_ip_ap_done),
    .ap_idle(sig_fir_ip_ap_idle),
    .ap_rst(sig_fir_ip_ap_rst),
    .ap_clk(aclk)
);

fir_ip_sub_in_if fir_ip_sub_in_if_U(
    .clk(aclk),
    .reset(sig_fir_ip_ap_rst),
    .sub_in_address0(sig_fir_ip_sub_in_address0),
    .sub_in_ce0(sig_fir_ip_sub_in_ce0),
    .sub_in_q0(sig_fir_ip_sub_in_q0),
    .Clk_A(sub_in_Clk_A),
...
fir_ip_sub_out_if fir_ip_sub_out_if_U(
    .clk(aclk),
    .reset(sig_fir_ip_ap_rst),
    .sub_out_address0(sig_fir_ip_sub_out_address0),
    .sub_out_ce0(sig_fir_ip_sub_out_ce0),
...
fir_ip_slv0_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_ap_start(sig_fir_ip_ap_start),
    .O_ap_ready(sig_fir_ip_ap_ready),
    .O_ap_done(sig_fir_ip_ap_done),
    .O_ap_idle(sig_fir_ip_ap_idle),
