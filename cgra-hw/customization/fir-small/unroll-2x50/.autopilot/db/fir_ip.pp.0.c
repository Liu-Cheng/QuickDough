...
void fir_ip(int sub_in[64 /* The number of fir taps + 1*/+1024 /* Length of the input signal*/+64 /* The number of fir taps + 1*/], int sub_out[1024 /* Length of the input signal*/]){
 int i;
 int j;

 fir_ip_label1:for(i=0; i<1024 /* Length of the input signal*/; i++){
  int tmp = 0;
  fir_ip_label0:for(j=0; j<64 /* The number of fir taps + 1*/; j++){
