...
#ifndef _sobel_ip_Gx_H_
#define _sobel_ip_Gx_H_
...
struct sobel_ip_Gx_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(sobel_ip_Gx_core);
    sobel_ip_Gx_core(sc_core::sc_module_name) {
...
SC_MODULE( sobel_ip_Gx )
{
    ...
    SC_CTOR( sobel_ip_Gx ) {
        meminst = new sobel_ip_Gx_core <2, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    sobel_ip_Gx_core <2, 1, DataWidth, AddressWidth, AddressRange>* meminst;
