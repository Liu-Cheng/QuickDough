...
#ifndef __mm_ip_mul_32s_32s_32_7__HH__
#define __mm_ip_mul_32s_32s_32_7__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(mm_ip_mul_32s_32s_32_7) {
    ...
    SC_CTOR(mm_ip_mul_32s_32s_32_7):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
